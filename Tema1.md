...
## Objetivo 1.1: Los sistemas operativos populares y la evolución de Linux

### Introducción

- Linux se desarrollo en 1991.
- Fue creado por Linus Torvalds.
- Se inspiró en Unix.
- Linux usa los mismo principios e ideas básicas de Unix.
- Linux en sí no contiene código Unix.
- Linux no está respaldado por una compañia individual.
- Linux está respaldado por una comunidad internacional de programadores.
- Linux está disponible gratuitamente.
- Puede ser usado por cualquier persona sin restricciones.

#### Distribuciones

- Es paquete que consiste en un kernel de linux y una selección de aplicaciones mantenidas por una empresa o comunidad de usuarios.
- El objetivo es optimizar el nucleo y las aplicaciones.
